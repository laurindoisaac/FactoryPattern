// src/lib.rs
/*
 * Core library for FactoryPattern
 */
...
#[derive(Debug)]
pub struct FactoryPatternProcessor {
    verbose: bool,
    processed_count: usize,
}

impl FactoryPatternProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting FactoryPattern processing");
    
    let mut processor = FactoryPatternProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = FactoryPatternProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = FactoryPatternProcessor::new(false);
